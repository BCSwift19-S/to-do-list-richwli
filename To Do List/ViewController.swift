...
class ViewController: UIViewController {
    ...
    var toDoNotesArray = ["Chanhyuk and Suhyun", "Taeyeon, Yuri, Hyoyeon, Sunny, Yoona, Tiffany, Sooyoung, and Seohyun", "Victoria, Amber, Luna, and Krystal", "CL, Bom, Sandara, and Minzy"]
